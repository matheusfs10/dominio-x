...
try {
  if (cmd === "provision") {
    ...
    const shared = {
      ...
      STORAGE_DRIVER: "s3",
      S3_ENDPOINT: "${{data-dominio-x.ENDPOINT}}",
      S3_ACCESS_KEY_ID: "${{data-dominio-x.ACCESS_KEY_ID}}",
      S3_SECRET_ACCESS_KEY: "${{data-dominio-x.SECRET_ACCESS_KEY}}",
      S3_BUCKET: "${{data-dominio-x.BUCKET}}",
      S3_REGION: "${{data-dominio-x.REGION}}",
