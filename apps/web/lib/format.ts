...
export const LABELS: Record<string, string> = {
  ...
  allow: "permitido",
  deny: "negado",
  // checagens do gate de tráfego (pagas)
  provider_state: "provedor indisponível",
  gate_enabled: "consulta automática desligada",
  max_digits: "dígitos demais no nome",
  max_hyphens: "hífens demais no nome",
  sld_length: "tamanho do nome fora da faixa",
  randomness: "nome aleatório demais",
  punycode: "nome IDN/punycode",
  dictionary_token: "sem palavra de dicionário",
  allowed_tld: "TLD fora da lista",
